 ...
 */
final class Version20230526132321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD country VARCHAR(100) NOT NULL, ADD year INT NOT NULL, CHANGE category_id category_id INT DEFAULT NULL');
    }
